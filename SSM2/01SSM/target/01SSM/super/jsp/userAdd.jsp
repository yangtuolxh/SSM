    ...
    <script  type="text/javascript">
        ...
        function ajaxForm(){
            ...
            $.ajax({
                ...
                //data:"name="+123,
                data:$('#form1').serialize(),// 你的form表单ID
        ...
        <div class="providerAdd">
            <form id="form1">
                ...
                <div class="">
                    ...
                    <input type="text" name="usercode" id="usercode"onkeyup="value=value.replace(/[^\d]/g,'')" required/>
                    <span>*请输入订单编码</span>
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="phone" id="phone" onkeyup="value=value.replace(/[^\d]/g,'')"  required/>
                    <span>*请输入大于0的正自然数，小数点后保留2位</span>
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="radio" name="usertype" value="2">经理<br>
                    <input type="radio" name="usertype" value="3">员工<br>
