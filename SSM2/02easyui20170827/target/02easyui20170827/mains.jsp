    ...
    <script type="text/javascript">
        var _menus = {"menus":[
            {"menuid":"1","icon":"icon-sys","menuname":"控件使用",
                "menus":[
                    {"menuid":"13","menuname":"用户管理","icon":"icon-users","url":"index.jsp"},
...
<%--
    <div class="footer">By 疯狂秀才(QQ:10558uery18239) jQ.Easy-UI QQ讨论群： 112044258、32994605、36534121、56271061</div>
--%>
</div>
